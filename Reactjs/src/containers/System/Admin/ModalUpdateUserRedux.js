...
class ModalUpdateUserRedux extends Component {
     ...
     checkValidateInput = () => {
          let isValid = true;
          let arrInput = ['email', 'firstName', 'lastName', 'address', 'gender', 'positionId', 'roleId'];
     ...
     render() {
          ...
          let { gender, isHaveData, positionId, roleId, genderArr, positionArr, roleIdArr } = this.state;
          return (
               <>
                    <Modal
                    ...
                    >
                         ...
                         <ModalFooter>
                              <Button color="primary" className="px-3" onClick={() => this.handleUpdateUserRedux()}>
                                   Add new
                              </Button>{' '}
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalUpdateUserRedux);
